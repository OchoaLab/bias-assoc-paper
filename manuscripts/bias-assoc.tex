...
One last detail worth noting is that PCs can change order upon the bias transformation, which we noticed in the simulation, where PC2 and PC3 from popkin actually correspond to PC1 and PC2, respectively, in both Standard and Weir-Goudet estimates (both ROM and MOR), and were plotted as such.
