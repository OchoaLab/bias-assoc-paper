...
$$
which agrees with the solution we found earlier for the standard kinship estimator, expect replacing $\bar{\varphi}$ with $\tilde{\varphi}$.
...
\begin{equation}
  ...
  \end{split}
\end{equation}
where $\AMinHat$ is an estimate of the minimum of the limiting values of \Ajk.
Here we employ $\AMinHat = \min_{j \ne k} \Ajk$.
This kinship estimator is accurate, namely by satisfying
$$
\ktHatNew \toas \kt,
$$
